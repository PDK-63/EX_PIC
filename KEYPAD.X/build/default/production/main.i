...
void Keypad(){
    PORTCbits.RC0 = 1, PORTCbits.RC1 = PORTCbits.RC2 = PORTCbits.RC3 = 0;
    if(PORTCbits.RC4 == 1){
        LCD_Data('7');
    ...
    PORTCbits.RC1 =1, PORTCbits.RC0 = PORTCbits.RC2 = PORTCbits.RC3 = 0;
    if(PORTCbits.RC4 == 1){
        LCD_Data('4');
        while(PORTCbits.RC4 == 1);
    }
    ...
    PORTCbits.RC2 = 1, PORTCbits.RC0 = PORTCbits.RC1 = PORTCbits.RC3 = 0;
    if(PORTCbits.RC4 == 1){
        LCD_Data('1');
        while(PORTCbits.RC4 == 1);
    }
    ...
    PORTCbits.RC3 = 1, PORTCbits.RC0 = PORTCbits.RC1 = PORTCbits.RC2 = 0;
    if(PORTCbits.RC4 == 1){
        LCD_Data('*');
        while(PORTCbits.RC4 == 1);
    }
